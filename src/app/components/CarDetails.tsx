          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                ...
                rounded 2xl bg-white text-left shadow-xl p-6 transition-all flex flex-col gap-5">
                  <button type="button"
                    onClick={closeModal}
...
<div className="flex gap-3">
  <div className="flex-1 relative w-full h-24 bg-primary-violet-100 rounded-lg">
  <Image 
